...
**97 + 8 = 105**, which is what `tests/testthat/test-api-surface.R` pins.
...
Tier arithmetic after this section: core 21 → **23**; advanced 33 → **34**;
advanced (experimental) 16 → **21**, of which the five new ones are the
population sub-label; total 97 → **105**.
