...
**97 + 6 = 103**, which is what `tests/testthat/test-api-surface.R` pins.
...
advanced (experimental) 16 → **20**, of which the four new ones are the
population sub-label; total 97 → **103**.
