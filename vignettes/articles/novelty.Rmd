...
[introduction vignette](introduction.html). That is Gate 2 in the ledger below.
...
[failure gallery](failure-gallery.html) shows six realistic errors that the
...
2. **Inherited decomposition family:** one plan yields signed, coherent,
   ...
   [introduction vignette](introduction.html) demonstrates the full
...
6. **Failure gallery:** executable safeguards for correlation-distance
   ...
   see the [failure gallery](failure-gallery.html). Callable unsupported
