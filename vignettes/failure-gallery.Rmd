...
vignette: >
  %\VignetteIndexEntry{Failure gallery}
...
Both reasons are separately actionable. Requirements that only restate the
missing channel — such as whether the partitions share one error structure —
cannot be evaluated without a channel to inspect, so they are not listed as
extra failures.
