...
| Query-first execution at scale | **Demonstrated** | Recorded gate artifact at q = 100 over 1,080 searchlights: selected 100 pairs 0.27 s, full fused RDM 5.16 s vs 13.40 s materialize-then-project, oracle error `4.4e-16`, and a maximum fresh-worker incremental R heap of 291 MB (277 MiB): [`benchmarks/run-query-first-scale.R`](https://github.com/bbuchsbaum/crossform/blob/main/benchmarks/run-query-first-scale.R), [`benchmark-results/query-first-scale-gate.rds`](https://github.com/bbuchsbaum/crossform/tree/main/benchmark-results), [`test-query-first-scale.R`](https://github.com/bbuchsbaum/crossform/blob/main/tests/testthat/test-query-first-scale.R). The materialized comparator remains in the timing court but outside the query-first memory claim; the heap receipt is not presented as OS RSS. |
