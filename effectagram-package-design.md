...
The package does not implement a method catalogue. It implements this algebra.
...
13. **Cross-null centering:** independent zero-effect partitions centre at zero in simulation.
...
Success criterion: randomized dense, brute-force region, and streamed variants agree to tolerance; zero-effect cross estimates centre at zero; conservative sums close numerically.
